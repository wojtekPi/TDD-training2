...
public class PaymentServiceTest {
    ...
    private static final Instrument THIRTY_TWO_PLN = new Instrument(32, PLN);
    ...
    private Object[][] parametersForSpecificMoneyTransfers() {
        return new Object[][]{
                {HUNDRED_PLN, TWO_PLN, THIRTY_PLN, SEVENTY_PLN, THIRTY_TWO_PLN},
    ...
    @Test
    public void shouldTransferPLNFromFirstAccountToAccountWithUSD() throws Exception{
        Account accountOne = new Account();
        accountOne.setId(1);
